...
<aside>
  ...
  <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
    ...
    <button type="submit" class="btn_1 rounded full-width add_top_60"><?php echo site_phrase('login'); ?></button>
    <div class="text-center add_top_10"><?php echo site_phrase('new_to').' <strong>'.get_settings('system_name').'</strong>'; ?>? <strong><a href="<?php echo site_url('home/sign_up'); ?>"><?php echo site_phrase('sign_up'); ?>!</a></strong></div>
