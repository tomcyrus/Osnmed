      ...
      <div class="row no-gutters">
        ...
        <div class="col-lg-8 text-center text-lg-right">
          ...
          <!-- <?php if ($this->session->userdata('admin_login')): ?>
           <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block" href="<?php echo site_url('admin'); ?>"><?php echo site_phrase('administrator'); ?></a></li>
           <?php endif; ?> -->
        ...
        <div class="collapse navbar-collapse" id="navigation">
          <ul class="navbar-nav ml-auto text-center">
            ...
            <li class="nav-item @@blog">
              <?php if ($this->session->userdata('admin_login')): ?>
              <a class="nav-link" href="<?php echo site_url('admin'); ?>"><?php echo site_phrase('administrator'); ?></a>
              <?php endif; ?>
              </li>
